...
FenServeur::FenServeur() : QWidget()
{
    ...
    code_newusers="/me";                                                    // Initialisation des codes de comprehension des messages
    ...
    QVBoxLayout *layout=new QVBoxLayout;                                    // Mise en forme
...
void FenServeur::nouvelleConnexion(){
    ...
    clients.insert(nouvelle_connexion);                                 // Ajoute le socket
...
void FenServeur::donneesRecues(){
   ...
   socket->canReadLine();
       ...
       qDebug() <<line;
                                                            // Initialisation des differents codes
       QRegExp meRegex("^"+code_newusers+":(.*)$");
       QRegExp meRegex2("^"+code_messageinstantannee+":(.*)$");
